...
get_ipython().run_line_magic('capture', '--no-stderr')
get_ipython().run_line_magic('pip', 'install -U langchain-nomic langchain_community tiktoken langchainhub chromadb langchain langgraph tavily-python nomic[local]')
